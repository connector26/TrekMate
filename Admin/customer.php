...
<!--Main body part-->
      <main role="main" class="col-md-9 ml-sm-auto col-lg-9 px-md-0">
        ...
        <div class=container>
            <div class=col-8>
              <table class=table>
                <tr><th>Name</th><th>Mobile</th><th>Address</th><th>Email</th><th>Password</th></tr> 
                <?php
                  include "../connect.php";
                  ...
                  {
                ?>
                <tr><td><?php echo $row[1];?></td><td><?php echo $row[0];?></td><td><?php echo $row[2];?></td><td><?php echo $row[3];?></td><td><?php echo $row[4];?></td></tr>
