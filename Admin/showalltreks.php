    ...
    <div class=col-9>
      ...
      <div class=container-fluid>
        <div class="row my-1">
          <?php
            include"../connect.php";
            $rs=pg_query($con,"select * from treks");
            while($row=pg_fetch_array($rs))
            {
          ?>
          <div class="col-3 offset-1 my-4">
            <div class="card" style="width: 18rem;">
              <img src="<?php echo $row[6]; ?>" class="card-img-top" alt="..." height=200px width=500px>
              <div class="card-body">
                <h5 class="card-title"><?php echo $row[1]; ?></h5>
                <p class="card-text"> <u>Descripton</u>:<br><?php echo $row[9] ;?> </p>
              </div>
              <ul class="list-group list-group-flush">
                <li class="list-group-item">Trek name: <?php echo $row[0]; ?></li>
                <li class="list-group-item">Location: <?php echo $row[1]; ?></li>
                <li class="list-group-item">Price: <?php echo $row[4]; ?></li>
              </ul>
              <div class="card-body">
              <a href="edittrek.php?tname=<?php echo $row[0];?>" class="btn btn-warning">Edit</a>
              </div>
            </div>
          </div>
          <?php
